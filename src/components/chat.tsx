...
const Chat = () => {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <h1 className="text-4xl font-bold mb-8 text-center">Chat en tiempo real</h1>
      <div
        style={{
      ...
      <div style={{ marginTop: "10px" }}>
        <input
          ...
          className="border border-gray-300 p-2 rounded focus:outline-none focus:shadow-outline w-5/6"
        />
        <button
          onClick={sendMessage}
